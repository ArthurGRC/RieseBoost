      ...
      <div className="flex flex-col items-center text-center">
        <div className="flex flex-col items-center pb-20">
          <div className="flex items-center">
            ...
            <h2 className="text-4xl font-bold leading-9 tracking-tight text-rbNight">Cheque seu email</h2>
          </div>
          <p className="text-sm text-rbGray text-wrap w-96">
            Entre no seu email e acesse o link fornecido para redefinir sua senha. Caso você não tenha recebido o email,
